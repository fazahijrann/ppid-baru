...
<body>
    <center>
        ...
        <table width="540">
            <tr>
                <td style="font-family: 'Times New Roman', Times, serif; font-size: 18px; text-align: center; font-weight: bold"
                    class="text">
                    <u>TANDA BUKTI PENERIMAAN
                        PERMOHONAN INFORMASI PUBLIK</u>
                </td>
            </tr>
        </table>
        <br /><br />
        <table width="530" style="text-align: justify">
            <tr>
                <td>Telah diterima permohonan informasi publik sebagai berikut :
                </td>
            </tr>
        </table>
        <table width="540" style="">
            ...
            <tr>
                <td width="120">Informasi Yang Diminta</td>
                <td width="20">:</td>
                <td width="335">{{ $data->rincian_informasi }}</td>
            </tr>
            <tr>
