        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                <a href="index" class="navbar-brand">
                    <h4 class="text-white" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">PPID<span class="text-dark" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);"> </span>KOTA BOGOR</h4>
                </a>
