        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <h1 class="display-4 text-white mb-4 animated slideInRight" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">PERMOHONAN INFORMASI</h1>
                    <h3 class="text-white mb-4 animated slideInRight" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Form Permohonan Informasi Publik</h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center justify-content-lg-start mb-0">
                            ...
                            @endif
                            <li class="breadcrumb-item"><a class="text-white" href="permohonaninformasi">Permohonan Informasi</a></li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <form action="{{ route('permohonan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <x-text-input id="no_permohonan_informasi" class="block mt-1 w-full" type="hidden" name="no_permohonan_informasi" :value="$newPermohonanInformasi" required readonly />

                                    <!-- Rincian Informasi -->
                                    <div class="form-group mb-3">
                                        <label for="rincian_informasi" class="text-dark fw-bold">Rincian Informasi yang Dibutuhkan</label>
                                        <textarea name="rincian_informasi" class="form-control" id="rincian_informasi" placeholder="Masukkan Rincian Keterangan">{{ old('rincian_informasi') }}</textarea>
                                    ...
                                    <!-- Tujuan Informasi -->
                                    <div class="form-group mb-3">
                                        <label for="tujuan_informasi" class="text-dark fw-bold">Tujuan Penggunaan Informasi</label>
                                        <input type="text" name="tujuan_informasi" class="form-control" id="tujuan_informasi" value="{{ old('tujuan_informasi') }}" placeholder="Masukkan Tujuan Penggunaan Informasi">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="id_kategori_memperoleh" class="text-dark fw-bold">Cara Memperoleh Informasi</label>
                                        <select name="id_kategori_memperoleh" class="form-control" id="id_kategori_memperoleh">
                                            <option value="">- Pilih -</option>
                                            <!-- @if(isset($kategori_memperoleh) && $kategori_memperoleh->count()) -->
                                            @foreach($kategori_memperoleh as $kategori)
                                            <option value="{{ $kategori->id }}" {{ old('id_kategori_memperoleh') == $kategori->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="id_kategori_salinan" class="text-dark fw-bold">Cara Mendapatkan Salinan Informasi</label>
                                        <select name="id_kategori_salinan" class="form-control" id="id_kategori_salinan">
                                            <option value="">- Pilih -</option>
                                            @if(isset($kategori_salinan) && $kategori_salinan->count())
                                            @foreach($kategori_salinan as $salinan)
                                            <option value="{{ $salinan->id }}" {{ old('id_kategori_salinan') == $salinan->id ? 'selected' : '' }}>
                            ...
                            <div class="form-check mb-4">
                                <input type="checkbox" class="form-check-input" id="check" name="pernyataan" value="1" {{ old('pernyataan') ? 'checked' : '' }}>
