<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div>
            ...
            <select id="id_kategori" name="id_kategori" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm"
                required>
        ...
        <!-- Form Pemohon -->
        <x-text-input id="no_pendaftaran" class="block mt-1 w-full" type="hidden" name="no_pendaftaran"
            :value="$newNoPendaftaran" required readonly />
        ...
        <div class="mt-3">
            ...
            <x-text-input id="file_ktp" class="block mt-1 w-full" type="file" name="file_ktp" accept=".pdf,.png"
                required />
        ...
        <div id="badan_hukum_fields" class="mt-3" style="display:none;">
            ...
            <div class="mt-3">
                ...
                <x-text-input id="nama_kuasa" class="block mt-1 w-full" type="text" name="nama_kuasa"
                    :value="old('nama_kuasa')" autocomplete="name" />
            ...
            <div class="mt-3">
                ...
                <x-text-input id="no_tlp_kuasa" class="block mt-1 w-full" type="text" name="no_tlp_kuasa"
                    :value="old('no_tlp_kuasa')" autocomplete="tel" />
            ...
            <div class="mt-3">
                ...
                <x-text-input id="sk_badanhukum" class="block mt-1 w-full" type="file" name="sk_badanhukum"
                    accept=".pdf" />
