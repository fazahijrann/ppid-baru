...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto align-items-center">
                        ...
                        <a href="daftarinformasipublik" class="nav-item nav-link active">Daftar Informasi Publik</a>
        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <h1 class="display-4 text-white mb-4 animated slideInRight" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">DAFTAR PPID PELAKSANA</h1>
                    <!-- <h4 class="text-white mb-4 animated slideInRight" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Pejabat Pengelola Informasi & Dokumentasi (PPID) KOTA BOGOR</h4> -->
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center justify-content-lg-start mb-0">
                            ...
                            @endif
                            <li class="breadcrumb-item"><a class="text-white" href="daftarinformasipublik">Daftar Informasi Publik</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="ppidpembantu">PPID Pelaksana</a></li>
                        </ol>
                    </nav>
                </div>
    ...
    <!-- About Start -->
    <div class="container-fluid bg-light feature py-5 mt-3 mb-3">
        <div class="container">
            <div class="text-center mb-5">
                <h1>DAFTAR PPID PELAKSANA</h1>
            </div>
            <table class="table text-start fw-bold">
                <tbody>
                    <tr>
                        <td scope="row">1</td>
                        <td>Daftar PPID Pelaksana</td>
                        <td class="text-end" width="100px">
                            <a href="#" target="__blank" class="btn btn-warning text-white">
                    ...
                    <tr>
                        ...
                        <td>Daftar PPID Pelaksana</td>
                        <td class="text-end" width="100px">
                            <a href="{{ asset('dokumen/informasi-realisasi-penggunaan-keuangan-tahun-2024.pdf') }}" target="_blank" class="btn btn-warning text-white">
                                <i class="fas fa-download"></i>
                            </a>
                        </td>
                    </tr>
