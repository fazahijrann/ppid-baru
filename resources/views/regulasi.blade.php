            ...
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto align-items-center">
                        ...
                        <a href="regulasi" class="nav-item nav-link active">Regulasi</a>
        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <h1 class="display-4 text-white mb-4 animated slideInRight" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">REGULASI INFORMASI</h1>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center justify-content-lg-start mb-0">
                            ...
                            @endif
                            <li class="breadcrumb-item"><a class="text-white" href="regulasi">Regulasi</a></li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="container-fluid bg-light feature py-5 mt-3 mb-3">
        <div class="container">
            <div class="text-center mb-5">
                <h1>Regulasi Informasi</h1>
            </div>
            <table class="table text-start fw-bold">
                <tbody>
                    <tr>
                        <td scope="row">1</td>
                        <td>Contoh konten media yang menampilkan pdf</td>
