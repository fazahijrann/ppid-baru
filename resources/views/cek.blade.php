                ...
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center justify-content-lg-start mb-0">
                            ...
                            @endif
                            <li class="breadcrumb-item"><a class="text-white" href="cek">Cek Status</a></li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container py-3">
            <div class="row">
                ...
                <div class="col-md-12 align-items-center justify-content-center">
                    ...
                    <div class="mt-4">
                        <div class="card shadow overflow-auto">
                            ...
                            <div class="card-body">
                                <table id="dataTabel" class="table table-striped table-bordered table-hover"
                                    style="width:100%">
                                    <thead class="bg-primary text-white text-center">
                                        <tr>
                                            <th>No</th>
                                            <th>No. Permohonan/Keberatan Informasi</th>
                                            <th>Nama Pemohon</th>
                                    ...
                                    <tbody>
                                        @php
                                            $total = 0; // Inisialisasi total untuk nomor urut
                                        @endphp

                                        <!-- Loop data permohonan informasi -->
                                        @foreach ($permohonan_informasi as $data)
                                            <tr>
                                                <td>{{ ++$total }}</td>
                                                <td>{{ $data->no_permohonan_informasi }}</td>
                                                <td>{{ $pemohon->nama }}</td>
                                                <td>Permohonan Informasi</td>
                                                <td>{{ $data->rincian_informasi }}</td>
                                                <td>{{ $data->created_at->format('d-m-Y') }}</td>
                                                <td>
                                                    {{-- {{ $data->tandaBuktiPenerimaan->status }} --}}
                                                    @if ($data->tandaBuktiPenerimaan)
                                                        @if ($data->tandaBuktiPenerimaan->status === 'Diteruskan')
                                                            {{ $data->tandaBuktiPenerimaan->tandaKeputusan->status ?? 'Tidak ada status tanda bukti' }}
                                                        @else
                                                            {{ $data->tandaBuktiPenerimaan->status }}
                                                        @endif
                                                    @else
                                                        {{-- Jika tidak ada tandaBuktiPenerimaan, tampilkan pesan default --}}
                                                        Tidak ada data tanda bukti penerimaan.
                                                    @endif
                                        ...
                                        <!-- Loop data keberatan informasi -->
                                        @foreach ($keberatan_informasi as $data)
                                            <tr>
                                                <td>{{ ++$total }}</td>
                                                <td>{{ $data->no_keberatan_informasi }}</td>
                                                <td>{{ $pemohon->nama }}</td>
                ...
                <!-- <div class="col-md-2 d-flex align-items-center justify-content-center">
                    <img src="img/status.png" class="img-fluid" alt="Descriptive Image" style="max-width: 250px;">
                </div> -->
            </div>
        </div>
    </div>
